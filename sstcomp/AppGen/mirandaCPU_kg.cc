...
RequestGenCPU_KG::RequestGenCPU_KG(SST::ComponentId_t id, SST::Params &params)
  ...
  clockHandler =
      new Clock::Handler2<RequestGenCPU_KG, &RequestGenCPU_KG::clockTick>(this);
  ...
  cache_link = loadUserSubComponent<Interfaces::StandardMem>(
      ...
      new Interfaces::StandardMem::Handler2<RequestGenCPU_KG,
                                            &RequestGenCPU_KG::handleEvent>(
          this));
  if (!cache_link) {
  ...
  if (reqGen) {
    ...
    if (!reqGenModName.empty()) {
      ...
      srcLink = configureLink(
          "src", "50ps",
          new Event::Handler2<RequestGenCPU_KG,
                              &RequestGenCPU_KG::handleSrcEvent>(this));
      if (NULL == srcLink) {
