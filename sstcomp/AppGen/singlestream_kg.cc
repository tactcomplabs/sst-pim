...
SingleStreamGenerator_KG::SingleStreamGenerator_KG(ComponentId_t id,
                                                   Params &params)
...
void SingleStreamGenerator_KG::build(Params &params) {
  ...
  out = new Output("SingleStreamGenerator_KG[@p:@l]: ", verbose, 0,
                   Output::STDOUT);
...
SingleStreamGenerator_KG::~SingleStreamGenerator_KG() { delete out; }

void SingleStreamGenerator_KG::generate(
...
bool SingleStreamGenerator_KG::isFinished() { return (issueCount == 0); }
