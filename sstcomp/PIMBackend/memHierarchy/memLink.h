...
#define MEMLINK_ELI_PARAMS                                                           \
  MEMLINKBASE_ELI_PARAMS, { "latency", "(string) Additional link latency.", "0ps" }, \
  ...
  public:
    ...
    virtual MemEventLinkInit* clone( void ) override { return new MemEventLinkInit( *this ); }
  ...
  /* Debug */
  virtual void printStatus( Output& out ) { out.output( "  MemHierarchy::MemLink: No status given\n" ); }
