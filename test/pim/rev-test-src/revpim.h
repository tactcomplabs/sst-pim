...
// rev_fast_print limited to a format string, 6 simple numeric parameters, 1024
// char max output
...
void init(PIM::FUNC_NUM f, uint64_t p0 = 0, uint64_t p1 = 0, uint64_t p2 = 0,
...
void init(PIM::FUNC_NUM f, uint64_t *ptr0, uint64_t *ptr1, size_t sz) {
  init(f, reinterpret_cast<uint64_t>(ptr0), reinterpret_cast<uint64_t>(ptr1),
       sz);
}

void init(PIM::FUNC_NUM f, uint64_t *ptr0, uint64_t *ptr1, uint64_t scalar,
          size_t sz) {
  init(f, reinterpret_cast<uint64_t>(ptr0), reinterpret_cast<uint64_t>(ptr1),
       scalar, sz);
}

void init(PIM::FUNC_NUM f, uint64_t *ptr0, uint64_t *ptr1, uint64_t *ptr2,
          size_t sz) {
  init(f, reinterpret_cast<uint64_t>(ptr0), reinterpret_cast<uint64_t>(ptr1),
       reinterpret_cast<uint64_t>(ptr2), sz);
}
